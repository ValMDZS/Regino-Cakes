...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="CSS/prinestilo.css">
...
>>>>>>> 7792c59403730a7a75fc0ffea99a552a5439df11
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-item active">
                <img src="img/publi1.jpeg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="img/publi2.jpeg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="img/publi3.jpeg" class="d-block w-100" alt="...">
            </div>
            </div>
        ...
        <div class="col-xl-4 col-md-4 col-lg-4 col-sm-12 col-12">
                <img src="img/RubiJ.jpg" class="card-img-top" alt="..."  >
                <div class="card-body">
                </div>
        </div>
    ...
    <div class="animacion">
        <img src="img/pas.jpg" width="100%">
    </div>

    <div class="publicidad">
        <p id="arriba">ECHA UN VISTAZO A NUESTROS</p>
        <P id="abajo">PRODUCTOS</P>
    </div>

    <div class="row">
        <div class="col-xl-3 col-md-3 col-lg-6 col-sm-6 col-6">
            <img src="img/choo.png" alt="">
            <p>Pastel de chocolate</p>
            <a href="" id="l">Ver más</a>
        </div>
        <div class="col-xl-3 col-md-3 col-lg-6 col-sm-6 col-6">
            <img src="img/zann.png" alt="">
            <p>Pastel de zanahoria</p>
            <a href="" id="l">Ver más</a>
        </div>
        <div class="col-xl-3 col-md-3 col-lg-6 col-sm-6 col-6">
            <img src="img/floo.png" alt="">
            <p>Macaroons</p>
            <a href="" id="l">Ver más</a>
        </div>
        <div class="col-xl-3 col-md-3 col-lg-6 col-sm-6 col-6">
            <img src="img/happ.png" alt="">
            <p>Pastel de cumpleaños</p>
            <a href="" id="l">Ver más</a>
        </div>
    </div>
</div> 
